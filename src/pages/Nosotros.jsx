          ...
          <div className={styles.expTop}>
            ...
            <motion.div variants={fadeInRight} className={styles.expTextBlock}>
              <p className={styles.expText}>
                Crom cuenta hoy con un alcance internacional, con presencia en +16 países y expandiéndonos, lo que le permite atender distintos mercados de la región con eficiencia y consistencia.
              </p>
            </motion.div>
            <motion.div variants={fadeInRight} className={styles.expTextBlock}>
              <p className={styles.expText}>
